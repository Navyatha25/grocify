...
const Category = () => {
  ...
  const renderCards = category.map(card=>{
    return(
      //card
      <div  key={card.id} className='md:flex-1 basis-[300px]'>
...
const category = [
  {
    ...
    description:'Fresh, organic produce sourced daily from localfarms.Explore a wide range of seasonal fruits and crisp vegetables.',
    image:FruitsCat,
    path:'/fruits'
  },
  {
  ...
  },
  {
    id:3,
    title:'Meat & SeaFood',
    description:'High-quality, responsibly sourced meat and seafood.Choose from fresh cuts, marinated options, and.',
    image:SeaFoodCat,
    path:'seafood'
  }
]
